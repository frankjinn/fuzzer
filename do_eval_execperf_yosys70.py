...
simulator_names = ['Yosys']
num_cells_list = [10] + [50*i for i in range(1, 8)] # Might increase to range(1, 41) 
simulators      = list(map(int, [SimulatorType.SIM_ICARUS])) #[SimulatorType.SIM_VERILATOR, SimulatorType.SIM_ICARUS, SimulatorType.SIM_CXXRTL]))
simlen = 70
...
with open('eval_execperf_yosys70.json', 'w') as f:
